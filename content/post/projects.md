...
<figure style="float: left; margin: 0 2rem 1rem 0;">
  <img src="/images/sciencelaptop.png" alt="student projects" style="max-width: 400px; width: 100%; border-radius: 8px;">
</figure>

<div style="display: flex; align-items: flex-start; gap: 1.5rem; margin: 2rem 4rem;">

  <p style="font-size: 1.05em; line-height: 1.8; font-style: italic;">
