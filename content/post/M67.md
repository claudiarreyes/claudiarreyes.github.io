...
A key focus of our work is the calibration of **seismic scaling relations** for mass and radius. We quantify the systematic errors introduced when surface term corrections are omitted from state-of-the-art stellar models, demonstrating how significantly the scaling relations are affected by missing corrections. Our mass estimates indicate little to no-mass-loss during the RGB.
