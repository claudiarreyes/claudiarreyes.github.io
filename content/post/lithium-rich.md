---
title: "Unveiling the Inner Workings of Lithium-rich Red Giants through Asteroseismology"
date: 2025-03-15
draft: false
featured_image: "/images/Li_cover.png"
description: ""
_build:
  list: never
---
...
Lithium is almost entirely destroyed as stars evolve up the red giant branch — yet a small fraction of red giants show lithium abundances far exceeding theoretical predictions. The origin of this lithium enrichment remains one of the outstanding puzzles in stellar astrophysics. 
...
<div style="display: flex; flex-wrap: wrap; align-items: flex-start; gap: 1.5rem; margin: 2rem clamp(0.5rem, 4vw, 4rem);">
  <img src="images/Li.png" alt="Lithium-rich red giants" style="flex: 1 1 200px; max-width: 100%; width: 50%; border-radius: 8px;">
</div>
